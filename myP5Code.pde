...
rect(cornerX+147,cornerY+180, 33, 4)
rect(cornerX+179,cornerY + 152, 4, 29)
arc(cornerX+179,cornerY + 180, 25, 55, radians(180), radians(270)); 
arc(cornerX+175,cornerY + 180, 55, 25, radians(180), radians(270));
